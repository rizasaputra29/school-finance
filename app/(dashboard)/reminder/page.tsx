				...
				<div className="flex items-center gap-2">
					...
					<span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#059DEA]/10 text-[#059DEA] text-sm font-medium">
						...
						<button
							...
							className="ml-1 hover:bg-[#059DEA]/20 rounded"
						>
							×
						</button>
					</span>
				...
				<Card>
					<CardContent className="flex flex-col items-center justify-center py-12">
						...
						<p className="text-sm text-gray-500">
							Semua pembayaran dan tagihan berjalan dengan baik
						</p>
					</CardContent>
				</Card>
			) : (
											...
											>
												<div className="flex-1 min-w-0">
													...
													<div className="flex items-center gap-4 mt-1">
														...
														{reminder.dueDate && (
															<p
																className={`text-sm ${isOverdue(reminder.dueDate) ? "text-red-600" : "text-gray-500"}`}
															>
													...
													<div className="flex items-center gap-2 mt-3">
														...
														>
															{reminder.type === "hutang" && (
																<CreditCard className="h-4 w-4 mr-1" />
															)}
															{reminder.type === "penyusutan" && (
																<BookOpen className="h-4 w-4 mr-1" />
															)}
															{reminder.type === "piutang" && (
																<Send className="h-4 w-4 mr-1" />
															)}
															{reminder.type === "payroll" && (
