						...
						<Table>
							<TableHeader>
								<TableRow className="bg-white">
									...
									<TableHead className="font-semibold text-gray-700 w-36 border-r">
										Debet
									</TableHead>
									<TableHead className="font-semibold text-gray-700 w-36 border-r">
										Kredit
								...
								{lines.map((line) => (
									...
									>
										<TableCell className="text-gray-600 border-r py-3">
											{formatDateTime(line.tanggal)}
										</TableCell>
										<TableCell className="text-gray-800 border-r font-medium text-[13px]">
											{line.namaAkun}
										</TableCell>
										<TableCell className="text-gray-700 border-r text-[13px]">
											{line.debit > 0 ? line.debit.toFixed(2) : "0.00"}
										</TableCell>
										<TableCell className="text-gray-700 border-r text-[13px]">
											{line.kredit > 0 ? line.kredit.toFixed(2) : "0.00"}
										</TableCell>
										<TableCell className="text-gray-500 text-[13px] truncate">
											{line.keterangan}{" "}
											{line.reference ? `| RefID: ${line.reference}` : ""}
										</TableCell>
									</TableRow>
								))}
