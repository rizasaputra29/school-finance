					...
					{transactions.slice(0, 4).map((tx) => (
						...
						>
							<div className="flex items-center gap-2 min-w-0 flex-1">
								<div className="h-7 w-7 md:h-8 md:w-8 rounded-lg bg-[#059DEA]/20 flex items-center justify-center shrink-0">
								...
								<div className="min-w-0 flex-1">
									...
									<p className="text-[10px] text-gray-400">
										{formatDate(tx.tanggal)} • {tx.reference}
									</p>
								</div>
							</div>
							<p className="font-semibold text-xs shrink-0 ml-2 text-gray-900">
