...
export default async function handler(
  ...
  try {
    const { fileData, sheets } = req.body;
    ...
    if (sheets.includes('Cashflow') && workbook.SheetNames.includes('Cashflow')) {
    ...
    if (sheets.includes('Data Siswa') && workbook.SheetNames.includes('Data Siswa')) {
    ...
    // Process Akun sheet
    if (sheets.includes('Akun') && workbook.SheetNames.includes('Akun')) {
