...
import { ErrorCodes } from "../api/api-errors";
import { error as createErrorResponse, errors } from "../api/api-response";
...
export function prismaErrorToResponse(err: unknown): NextResponse {
	...
	return createErrorResponse(result.message, result.code, {
